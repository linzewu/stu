...
function _show_install_dialog(ProductName, InstallerUrl, bHTML5, bMac, bIE, bSafari, bSSL, strIEVersion){
	...
	if(bHTML5){
		...
		if(bIE){
			...
			ObjString.push('<div class="dwt-red" style="padding-top: 10px;">If you still see this dialog, please REFRESH your browser.</div>');
		}
		...
		if(bIE){
			...
			ObjString.push('<p class="dwt-red" style="padding-top: 10px;">If you still see this dialog, please REFRESH your browser.</p>');
		}
	}
